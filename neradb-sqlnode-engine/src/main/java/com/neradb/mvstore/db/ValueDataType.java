...
import com.neradb.mvstore.WriteBuffer;
import com.neradb.mvstore.rtree.SpatialDataType;
import com.neradb.mvstore.rtree.SpatialKey;
import com.neradb.mvstore.type.DataType;
...
import com.neradb.value.ValueByte;
...
import com.neradb.value.ValueFloat;
import com.neradb.value.ValueInt;
import com.neradb.value.ValueJavaObject;
...
import com.neradb.value.ValueShort;
import com.neradb.value.ValueString;
import com.neradb.value.ValueStringFixed;
import com.neradb.value.ValueStringIgnoreCase;
import com.neradb.value.ValueTime;
import com.neradb.value.ValueTimestamp;
import com.neradb.value.ValueTimestampTimeZone;
import com.neradb.value.ValueUuid;
        ...
        case Value.RESULT_SET: {
            ...
            try {
                ...
                while (rs.next()) {
                    buff.put((byte) 1);
                    for (int i = 0; i < columnCount; i++) {
                        int t = com.neradb.value.DataType.
                                getValueTypeFromResultSet(meta, i + 1);
                        Value val = com.neradb.value.DataType.readValue(
                                null, rs, i + 1, t);
                        writeValue(buff, val);
                    }
                }
