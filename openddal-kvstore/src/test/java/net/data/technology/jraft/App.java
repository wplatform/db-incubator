...
import com.openddal.kvstore.raft.ClusterConfiguration;
import com.openddal.kvstore.raft.ClusterServer;
import com.openddal.kvstore.raft.LogEntry;
import com.openddal.kvstore.raft.LogValueType;
import com.openddal.kvstore.raft.RaftClient;
import com.openddal.kvstore.raft.RaftConsensus;
import com.openddal.kvstore.raft.RaftContext;
import com.openddal.kvstore.raft.RaftMessageType;
import com.openddal.kvstore.raft.RaftParameters;
import com.openddal.kvstore.raft.RaftRequestMessage;
import com.openddal.kvstore.raft.RaftResponseMessage;
import com.openddal.kvstore.raft.RpcClient;

import extensions.FileBasedServerStateManager;
import extensions.RpcTcpClientFactory;
import extensions.RpcTcpListener;

public class App
{
    public static void main( String[] args ) throws Exception
    {
    	args = new String[]{"server","D:/test"};
        if(args.length < 2){
