...
import com.neradb.common.utils.SimpleRowSource;
...
public abstract class TriggerAdapter implements Trigger {
	 ...
	 * database is opened. The default implementation initialized the result sets.
	 *
	 * @param conn
	 ...
	 * ResultSet.next does not need to be called (and calling it has no effect; it
	 * will always return true).
	 * <p>
	 * For "before" triggers, the new values of the new row may be changed using the
	 * ResultSet.updateX methods.
	 * </p>
	 *
	 * @param conn
	 *            a connection to the database
	...
	/**
	 * This method is called when the trigger is dropped. The default implementation
	 * does nothing.
	 */
	@Override
