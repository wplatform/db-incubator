...
import com.neradb.command.ddl.AlterIndexRename;
import com.neradb.command.ddl.AlterSchemaRename;
import com.neradb.command.ddl.AlterTableAddConstraint;
import com.neradb.command.ddl.AlterTableAlterColumn;
import com.neradb.command.ddl.AlterTableDropConstraint;
import com.neradb.command.ddl.AlterTableRename;
import com.neradb.command.ddl.AlterTableRenameColumn;
import com.neradb.command.ddl.AlterTableRenameConstraint;
import com.neradb.command.ddl.AlterUser;
import com.neradb.command.ddl.AlterView;
import com.neradb.command.ddl.Analyze;
import com.neradb.command.ddl.CreateAggregate;
import com.neradb.command.ddl.CreateConstant;
import com.neradb.command.ddl.CreateFunctionAlias;
import com.neradb.command.ddl.CreateIndex;
import com.neradb.command.ddl.CreateRole;
import com.neradb.command.ddl.CreateSchema;
import com.neradb.command.ddl.CreateSequence;
import com.neradb.command.ddl.CreateTable;
import com.neradb.command.ddl.CreateTableData;
import com.neradb.command.ddl.CreateTrigger;
import com.neradb.command.ddl.CreateUser;
import com.neradb.command.ddl.CreateUserDataType;
import com.neradb.command.ddl.CreateView;
import com.neradb.command.ddl.DeallocateProcedure;
import com.neradb.command.ddl.DefineCommand;
import com.neradb.command.ddl.DropAggregate;
import com.neradb.command.ddl.DropConstant;
import com.neradb.command.ddl.DropDatabase;
import com.neradb.command.ddl.DropFunctionAlias;
import com.neradb.command.ddl.DropIndex;
import com.neradb.command.ddl.DropRole;
import com.neradb.command.ddl.DropSchema;
import com.neradb.command.ddl.DropSequence;
import com.neradb.command.ddl.DropTable;
import com.neradb.command.ddl.DropTrigger;
import com.neradb.command.ddl.DropUser;
import com.neradb.command.ddl.DropUserDataType;
import com.neradb.command.ddl.DropView;
import com.neradb.command.ddl.GrantRevoke;
import com.neradb.command.ddl.PrepareProcedure;
import com.neradb.command.ddl.SetComment;
import com.neradb.command.ddl.TruncateTable;
import com.neradb.command.dml.AlterSequence;
import com.neradb.command.dml.AlterTableSet;
import com.neradb.command.dml.BackupCommand;
import com.neradb.command.dml.Call;
import com.neradb.command.dml.Delete;
import com.neradb.command.dml.ExecuteProcedure;
import com.neradb.command.dml.Explain;
import com.neradb.command.dml.Insert;
import com.neradb.command.dml.Merge;
import com.neradb.command.dml.NoOperation;
import com.neradb.command.dml.Query;
import com.neradb.command.dml.Replace;
import com.neradb.command.dml.RunScriptCommand;
import com.neradb.command.dml.ScriptCommand;
import com.neradb.command.dml.Select;
import com.neradb.command.dml.SelectOrderBy;
import com.neradb.command.dml.SelectUnion;
import com.neradb.command.dml.Set;
import com.neradb.command.dml.SetTypes;
import com.neradb.command.dml.TransactionCommand;
import com.neradb.command.dml.Update;
import com.neradb.command.expression.Aggregate;
import com.neradb.command.expression.Alias;
import com.neradb.command.expression.CompareLike;
import com.neradb.command.expression.Comparison;
import com.neradb.command.expression.ConditionAndOr;
import com.neradb.command.expression.ConditionExists;
import com.neradb.command.expression.ConditionIn;
import com.neradb.command.expression.ConditionInSelect;
import com.neradb.command.expression.ConditionNot;
import com.neradb.command.expression.Expression;
import com.neradb.command.expression.ExpressionColumn;
import com.neradb.command.expression.ExpressionList;
import com.neradb.command.expression.Function;
import com.neradb.command.expression.FunctionCall;
import com.neradb.command.expression.JavaAggregate;
import com.neradb.command.expression.JavaFunction;
import com.neradb.command.expression.Operation;
import com.neradb.command.expression.Parameter;
import com.neradb.command.expression.Rownum;
import com.neradb.command.expression.SequenceValue;
import com.neradb.command.expression.Subquery;
import com.neradb.command.expression.TableFunction;
import com.neradb.command.expression.ValueExpression;
import com.neradb.command.expression.Variable;
import com.neradb.command.expression.Wildcard;
...
import com.neradb.dbobject.table.IndexHints;
...
import com.neradb.value.ValueBytes;
import com.neradb.value.ValueDate;
import com.neradb.value.ValueDecimal;
...
import com.neradb.value.ValueTimestamp;
...
public class Parser {
    ...
    /**
     * @see com.neradb.engine.DbSettings#databaseToUpper
     */
