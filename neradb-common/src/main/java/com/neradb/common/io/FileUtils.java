...
public class FileUtils {
	...
	/**
	 * Create a directory (all required parent directories must already exist). This
	 * method is similar to Java 7 <code>java.nio.file.Path.createDirectory</code>.
	 *
	 * @param directoryName
	 *            the directory name
	 */
	...
	/**
	 * Delete a file or directory if it exists. Directories may only be deleted if
	 * they are empty. This method is similar to Java 7
	...
	/**
	 * Get the canonical file or directory name. This method is similar to Java 7
	 * <code>java.nio.file.Path.toRealPath</code>.
	 *
	 * @param fileName
	 *            the file name
	...
	/**
	 * Get the parent directory of a file or directory. This method returns null if
	 * there is no parent. This method is similar to Java 7
	...
	/**
	 * Rename a file if this is allowed, and try to atomically replace an existing
	 * file. This method is similar to Java 7 <code>java.nio.file.Files.move</code>.
	 *
	 * @param source
	 *            the old fully qualified file name
	 * @param target
	...
	/**
	 * Get the file or directory name (the last element of the path). This method is
	 * similar to Java 7 <code>java.nio.file.Path.getName</code>.
	 *
	 * @param path
	...
	/**
	 * List the files and directories in the given directory. This method is similar
	 * to Java 7 <code>java.nio.file.Path.newDirectoryStream</code>.
	 *
	 * @param path
	 *            the directory
	...
	/**
	 * Create an input stream to read from the file. This method is similar to Java
	 * 7 <code>java.nio.file.Path.newInputStream</code>.
	 *
	 * @param fileName
	 *            the file name
	 ...
	 *            the file name
	 * @param append
	 *            if true, the file will grow, if false, the file will be truncated
	 *            first
